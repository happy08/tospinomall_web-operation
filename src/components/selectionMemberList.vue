            ...
            <el-tab-pane name="first">
                ...
                <el-checkbox-group v-model="tableSelectionIds">
                    <BmTable :data="tableData" @row-click="handleRowClick" height="380" class="mb-20">
                        ...
                        <BmTableColumn prop="email" :label="$t('memberListTable.email')"> </BmTableColumn>
                    </BmTable>
                </el-checkbox-group>
...
import { buyerFindByByConditions } from "@/api/permission";
...
export default {
    ...
    setup(props, { emit }) {
        ...
        //获取会员列表
        const initData = () => {
            buyerFindByByConditions(searchForm)
                .then((res) => {
        ...
        watch(
            ...
            (nVal) => {
                ...
                if (nVal && nVal.length > 0) {
                    buyerFindByByConditions({ ids: ids })
                        .then((res) => {
