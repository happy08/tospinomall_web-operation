<template>
    <div class="mb-15">{{ $t("storeDesign.recommendedSize") }}:1920px * 70px</div>
    <div v-if="config.componentDetails.length > 0">
    ...
    <div v-else class="tc orange">
        {{ $t("storeDesign.noTopAD") }}
    </div>
...
export default {
    name: "StoreDesignEditTopAdvertising",
