<template>
    ...
    <div class="p-25 bg-white round-4">
        ...
        <el-form ref="formRef" :model="bankTableData" :rules="rules" label-width="100px" class="border pt-20 mb-20">
            ...
            <el-form-item>
                <!-- 保持修改 -->
                <el-button @click="handleSave(bankTableData, 1)" type="primary" :disabled="disabled">{{ $t("withdrawalPaymentChannels.keepChange") }}</el-button>
                <!-- 查看绑定国家 -->
                <el-button @click="handleOpen(bankTableData)">{{ $t("withdrawalPaymentChannels.viewBindingCountry") }}</el-button>
            </el-form-item>
        </el-form>
        <!-- Payonner - 派安盈 -->
        ...
        <el-form ref="formRef" :model="payTableData" :rules="rules" label-width="100px" class="border pt-20 mb-20">
            ...
            <el-form-item>
                <!-- 保持修改 -->
                <el-button v-permission="'financeSetting_withdrawalPaymentChannels_save'" @click="handleSave(payTableData, 2)" type="primary" :disabled="disabled">{{
                    $t("withdrawalPaymentChannels.keepChange")
                }}</el-button>
                <!-- 查看绑定国家 -->
                <el-button v-permission="'financeSetting_withdrawalPaymentChannels_look'" @click="handleOpen(payTableData)">{{ $t("withdrawalPaymentChannels.viewBindingCountry") }}</el-button>
            </el-form-item>
        </el-form>
    </div>
    <!-- 绑定国家信息Drawer抽屉 -->
