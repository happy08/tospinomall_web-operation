    ...
    <BmDialog v-model:visible="visible" :title="$t('table.detail')" :width="1000" @close="cancel" top="10vh">
        ...
        <div class="p-20 bg-white round-4">
            ...
            <el-form :model="form" ref="formRef" label-width="auto">
                ...
                <div v-if="form.type.length > 0">
                    ...
                    <div>
                        <BmImage v-if="form.pictures" :src="form.pictures.split(',')" class="m-5" style="width:60px;height:60px" />
                    </div>
        ...
        <template #footer>
            <div class="flex hcenter vcenter">
                ...
                <el-button @click="reject" type="primary" plain>{{ $t("reject") }}</el-button>
                <el-button @click="confirm" type="primary">{{ $t("pass") }}</el-button>
            </div>
        </template>
    </BmDialog>

    <!-- 驳回弹窗 -->
    <BmDialog v-model:visible="rejectVisible" :title="$t('table.detail')" :width="500" :cancel="rejectCancel" :confirm="rejectConfirm" top="10vh">
        <el-form :model="form" ref="formRef" label-width="auto">
