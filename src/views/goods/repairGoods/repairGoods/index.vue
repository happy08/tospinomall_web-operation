<template>
    <template v-if="!editVisible">
        <div class="top-search-form">
            ...
            <el-form :model="searchForm" ref="searchFormRef" labelPosition="top" class="table-search-form">
                <el-row :gutter="24">
                    ...
                    <el-col :md="12" :lg="6">
                        <el-form-item label="TSIN" prop="tsin">
        ...
        <div class="p-25 bg-white round-4">
            ...
            <BmTable ref="multipleTable" :data="tableData" class="mb-20">
                <BmTableColumn :label="$t('repairGoods.goodsInfo')" align="center" width="300">
...
export default {
    ...
    setup() {
        ...
        //搜索
        const handelSearch = () => {
            searchForm.startTime = proxy.utils.formatStandardDate(searchForm._timeType && searchForm._timeType[0], 1) || "";
            searchForm.endTime = proxy.utils.formatStandardDate(searchForm._timeType && searchForm._timeType[1], 1) || "";
